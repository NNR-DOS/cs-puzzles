...
public class StringDecomposition {
    ...
    */
    ...
    /*
      Take every snippet taken from the 'workingIndex' to the end of the
      string. This is out of the 'possibility space' that we can recurse into.
    */
    ...
    */
    ...
    public static void main(String[] args) {
        System.out.println(partition("aaa").size());
    }
}
