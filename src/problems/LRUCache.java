...
public class LRUCache {
    ...
    public void put(int key, int value) {
        if (this.hashMap.containsKey(key)) {
            ...
            this.cache.remove(key);
            this.cache.addFirst(key);
        } else if (!this.hashMap.containsKey(key) && this.hashMap.size() == this.capacity) {
            this.hashMap.put(key, value);
            this.cache.addFirst(key);
            int removedKey = this.cache.removeLast();
            this.hashMap.remove(removedKey);
        } else {
            this.hashMap.put(key, value);
            this.cache.addFirst(key);
        }
...
//            if (set.length == 1) {
//                if (set[0] == 12) {
//                    System.out.println(cache.get(set[0]));
//                } else {
//                    System.out.println(cache.get(set[0]));
//                }
//            }
